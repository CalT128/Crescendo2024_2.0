...
public final class Constants {
  public static class SwerveDriveConstants {
    ...
    public static final double rKP = 0.01;
    public static final double rKI = 0.001;
    public static final double rKD = 0.002;
  ...
  public static class ShooterConstants{
    ...
    public static final double shooterIntakePosition = 0.56;
    ...
    public static final double shooterClimbPosition = 2.2;
  ...
  public static class VisionConstants {
    public static final double INITIAL_LL_ANGLE = 24.725; //degrees
